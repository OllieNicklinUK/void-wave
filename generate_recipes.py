...
DEFAULTS = {
    ...
    # Slots 1–9 free; slot 10 = COLOUR (MACRO1→FILTER_CUTOFF); slot 11 = SATURATION (MACRO2→FILTER_DRIVE)
    **{f"mod{i}_source":  0   for i in range(1, 10)},
    **{f"mod{i}_dest":    0   for i in range(1, 10)},
    **{f"mod{i}_depth":   0.0 for i in range(1, 10)},
    **{f"mod{i}_enabled": 0   for i in range(1, 10)},
    "mod10_source": 10, "mod10_dest": 10, "mod10_depth": 0.5,  "mod10_enabled": 1,
    "mod11_source": 11, "mod11_dest": 12, "mod11_depth": 0.8,  "mod11_enabled": 1,
    "mod12_source":  0, "mod12_dest":  0, "mod12_depth": 0.0,  "mod12_enabled": 0,
    "macro1": 0.0, "macro2": 0.0, "macro3": 0.0, "macro4": 0.0,
    "sub_level": 0.0, "sub_octave": 0, "noise_level": 0.0, "noise_color": 0.0,
